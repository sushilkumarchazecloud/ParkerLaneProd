({
    ...
    deleteRow: function(component, event,helper) {
        ...
        if(rowType === 'EarningIncome1'){
            ...
            helper.deleteEmploymentDetails(component, event, index, 'employmentsList1');
            ...
            helper.deleteEmploymentDetails(component, event, index, 'employmentsList2');
            employmentsList.splice(index,1);
            ...
            var employmentsList = component.get("v.employmentsList1");
            helper.deleteEmploymentPrevioudAddress(component, event, index, 'employmentsList1');
            preEmpList.splice(index,1);
            component.set("v.preEmpList1", preEmpList);

            if(preEmpList.length<1){
                helper.checkMonthYear(component, event,employmentsList[0],1);
                //component.set("v.showPreviousEmpHistory1", true);
            }
        }else if(rowType === 'preEmpHistory2'){
            var preEmpList = component.get("v.preEmpList2");
            var employmentsList = component.get("v.employmentsList2");
            helper.deleteEmploymentPrevioudAddress(component, event,index, 'employmentsList2');
            preEmpList.splice(index,1);
            component.set("v.preEmpList2", preEmpList);

            if(preEmpList.length<1){
                helper.checkMonthYear(component, event,employmentsList[0],2);
    ...
    totalPersonalIncome:function(component, event, helper) {
        
       helper.totalPersonalIncome(component, event, helper);
    }
